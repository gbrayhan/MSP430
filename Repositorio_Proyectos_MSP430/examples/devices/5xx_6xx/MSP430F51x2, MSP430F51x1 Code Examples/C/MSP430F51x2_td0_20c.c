//******************************************************************************
//  MSP430F51x2 Demo - TimerD0, Hi-Res Free Running mode, PWM TD0.0-2, TDCLK = 200Mhz
//
...
//  table. 
//
//  ACLK=REFO; SMCLK=MCLK=DCOclock=25MHz; TDCLK(TLV Cal Data)= 200Mhz
//  Note: 1. DCO should be set to 25Mhz and TDHMx=00(8x) to use the 200Mhz TimerD TLV data
...
//          --|RST          XOUT|-
//            |                 |
//            |       P1.6/TD0.0|--> CCR0 - 50% dutycycle; PWM period = (2 x 128)/200MHz~ 1.28us = 780kHz
//            |       P1.7/TD0.1|--> CCR1 - 25% dutycycle; ON period ~ 32/200MHz~ 250ns
//            |       P2.0/TD0.2|--> CCR2 - 75% dutycycle; ON period ~ 96/200MHz~ 750ns
//
//  B. Nisarga
