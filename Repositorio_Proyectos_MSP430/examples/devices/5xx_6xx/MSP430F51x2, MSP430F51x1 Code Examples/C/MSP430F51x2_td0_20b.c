//******************************************************************************
//  MSP430F51x2 Demo - TimerD0, Hi-Res Free Running mode, PWM TD0.0-2, TDCLK = 128Mhz
//
...
//  table. 
//
//  ACLK=REFO; SMCLK=MCLK=DCOclock=16MHz; TDCLK(TLV Cal Data)= 128Mhz
//  Note: 1. DCO should be set to 16Mhz and TDHMx=00(8x) to use the 128Mhz TimerD TLV data
...
//          --|RST          XOUT|-
//            |                 |
//            |       P1.6/TD0.0|--> CCR0 - 50% dutycycle; PWM period = (2 x 128)/128MHz~ 2us = 500kHz
//            |       P1.7/TD0.1|--> CCR1 - 25% dutycycle; ON period ~ 32/128MHz~ 250ns
//            |       P2.0/TD0.2|--> CCR2 - 75% dutycycle; ON period ~ 96/128MHz~ 750ns
//
//  B. Nisarga
