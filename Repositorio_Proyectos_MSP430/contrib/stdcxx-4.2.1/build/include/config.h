// configured for gcc-4.6.1 on Linux 3.0.0-16-generic-pae
...
#define _RWSTD_ANSI_C_FLOAT_H "/usr/lib/gcc/i686-linux-gnu/4.6.1/include/float.h"
#define _RWSTD_NO_CISO646
#define _RWSTD_ANSI_C_ISO646_H "/usr/lib/gcc/i686-linux-gnu/4.6.1/include/iso646.h"
#define _RWSTD_NO_CLIMITS
#define _RWSTD_ANSI_C_LIMITS_H "/usr/lib/gcc/i686-linux-gnu/4.6.1/include-fixed/limits.h"
...
#define _RWSTD_ANSI_C_STDARG_H "/usr/lib/gcc/i686-linux-gnu/4.6.1/include/stdarg.h"
#define _RWSTD_NO_CSTDDEF
#define _RWSTD_ANSI_C_STDDEF_H "/usr/lib/gcc/i686-linux-gnu/4.6.1/include/stddef.h"
...
#define _RWSTD_CTYPE_UPPER 0x00000100   /* libc value */
#define _RWSTD_CTYPE_LOWER 0x00000200   /* libc value */
#define _RWSTD_CTYPE_DIGIT 0x00000800   /* libc value */
#define _RWSTD_CTYPE_SPACE 0x00002000   /* libc value */
#define _RWSTD_CTYPE_PUNCT 0x00000004   /* libc value */
#define _RWSTD_CTYPE_CNTRL 0x00000002   /* libc value */
#define _RWSTD_CTYPE_BLANK 0x00000001   /* libc value */
#define _RWSTD_CTYPE_XDIGIT 0x00001000   /* libc value */
#define _RWSTD_CTYPE_GRAPH 0x00008000   /* libc value */
#define _RWSTD_CTYPE_ALPHA 0x00000400   /* libc value */
#define _RWSTD_CTYPE_PRINT 0x00004000   /* libc value */
#define _RWSTD_CTYPE_ALNUM 0x00000008   /* libc value */
...
#define _RWSTD_DBL_MAX          1.79769313486231571e+308
#define _RWSTD_FLT_MAX          3.40282346638528859812e+38F
#define _RWSTD_LDBL_MAX         1.18973149535723176502e+4932L
#define _RWSTD_DBL_EPSILON      2.22044604925031308e-16
#define _RWSTD_DBL_MIN          2.22507385850720138e-308
#define _RWSTD_FLT_EPSILON      1.19209289550781250000e-7F
#define _RWSTD_FLT_MIN          1.17549435082228750797e-38F
...
#define _RWSTD_ICONV_ARG2_T char**
...
#define _RWSTD_LCONV {   /* sizeof (lconv) == 56 */ \
    char* decimal_point;   \
    char* thousands_sep;   \
    char* grouping;   \
...
#define _RWSTD_LC_NAME               8
#define _RWSTD_LC_PAPER              7
#define _RWSTD_LC_IDENTIFICATION    12
#define _RWSTD_LC_ADDRESS            9
#define _RWSTD_LC_TELEPHONE         10
#define _RWSTD_LC_MEASUREMENT       11
...
#define _RWSTD_CAT_7(pfx) { 8, "LC_NAME", pfx::_C_name }
#define _RWSTD_CAT_6(pfx) { 7, "LC_PAPER", pfx::_C_paper }
#define _RWSTD_CAT_11(pfx) { 12, "LC_IDENTIFICATION", pfx::_C_ident }
#define _RWSTD_CAT_8(pfx) { 9, "LC_ADDRESS", pfx::_C_address }
#define _RWSTD_CAT_9(pfx) { 10, "LC_TELEPHONE", pfx::_C_telephone }
#define _RWSTD_CAT_10(pfx) { 11, "LC_MEASUREMENT", pfx::_C_measurement }
...
#define _RWSTD_MBSTATE_T_SIZE 8
...
#define _RWSTD_STRUCT_TM {   /* sizeof (struct tm) == 44          */ \
...
#define _RWSTD_OS_LINUX
#define _RWSTD_OS_SYSNAME "LINUX"
#define _RWSTD_OS_RELEASE "3.0.0-16-generic-pae"
#define _RWSTD_OS_VERSION "#28-Ubuntu SMP Fri Jan 27 19:24:01 UTC 2012"
#define _RWSTD_OS_MAJOR 3
#define _RWSTD_OS_MINOR 0
#define _RWSTD_OS_MICRO 0
#define _RWSTD_LINUX_RELEASE "DISTRIB_ID=Ubuntu"
...
#define _RWSTD_O_APPEND                0x400   // O_APPEND
#define _RWSTD_O_EXCL                   0x80   // O_EXCL
#define _RWSTD_O_CREAT                  0x40   // O_CREAT
...
#define _RWSTD_WINT_T   unsigned
#define _RWSTD_WINT_MIN _RWSTD_UINT_MIN
