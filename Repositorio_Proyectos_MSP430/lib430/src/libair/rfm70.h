...
typedef enum {
	RFM70_ADDR_3BYTE		= 0x01,		///<@const Use 3-byte addressing
	RFM70_ADDR_4BYTE		= 0x02, 	///<@const Use 4-byte addressing
	RFM70_ADDR_5BYTE		= 0x03		///<@const Use 5-byte addressing
} RFM70_ADDR_SIZE;

// RFM70 Registers
typedef enum {
	RFM70_REG_CONFIG		= 0x00,		///<@const Configuration register
	RFM70_REG_EN_AA			= 0x01,		///<@const ...
	RFM70_REG_EN_RXADDR		= 0x02,		///<@const ...
	RFM70_REG_SETUP_AW		= 0x03,		///<@const ...
	RFM70_REG_SETUP_RETR	= 0x04,		///<@const ...
	RFM70_REG_RF_CH			= 0x05,		///<@const ...
	RFM70_REG_RF_SETUP		= 0x06,		///<@const ...
	RFM70_REG_STATUS		= 0x07,		///<@const ...
	RFM70_REG_OBSERVE_TX	= 0x08,		///<@const ...
	RFM70_REG_CD			= 0x09,		///<@const ...
	RFM70_REG_RX_ADDR_P0	= 0x0A,		///<@const ...
	RFM70_REG_RX_ADDR_P1	= 0x0B,		///<@const ...
	RFM70_REG_RX_ADDR_P2	= 0x0C,		///<@const ...
	RFM70_REG_RX_ADDR_P3	= 0x0D,		///<@const ...
	RFM70_REG_RX_ADDR_P4	= 0x0E,		///<@const ...
	RFM70_REG_RX_ADDR_P5	= 0x0F,		///<@const ...
	RFM70_REG_TX_ADDR		= 0x10,		///<@const ...
	RFM70_REG_RX_PW_P0		= 0x11,		///<@const ...
	RFM70_REG_RX_PW_P1		= 0x12,		///<@const ...
	RFM70_REG_RX_PW_P2		= 0x13,		///<@const ...
	RFM70_REG_RX_PW_P3		= 0x14,		///<@const ...
	RFM70_REG_RX_PW_P4		= 0x15,		///<@const ...
	RFM70_REG_RX_PW_P5		= 0x16,		///<@const ...
	RFM70_REG_FIFO_STATUS	= 0x17,		///<@const ...
	RFM70_REG_DYNPD			= 0x1C,		///<@const ...
	RFM70_REG_FEATURE		= 0x1D		///<@const ...
} RFM70_REG;
 ...
 */
unsigned int rfm70_get_register( RFM70* radio , RFM70_REG register);
