//******************************************************************************
//  MSP430F66x Demo - DMA0, Single transfer using ADC12 triggered by TimerB
//
...
unsigned int DMA_DST;			    // ADC conversion result
...
void main(void)
{
  ...
  P4SEL |= BIT1;                            // P4.1 TB1 option select
  P4DIR |= BIT1;                            // Output direction
